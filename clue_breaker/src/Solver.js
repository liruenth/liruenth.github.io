...
//   if other.name !== possible.name && possible.accusationIds.some(id => !other.accusationIds.includes(id)) 
//   */
...
//         possible.accusationIds.some(id => other.accusationIds.includes(id))
//       );
//     }
//     )
//   );
...
// /*
//   this messed up after 
//   - players `jim`, `west`, `test`, `best`
//   - start with `ballroom` and `hall` as knowns
//   - add `revolver` to `jim`
//   - make accusation `west`, `green`, `pipe`, `billiard`, `test`
//   - make accusation `test`, `mustard`, `pipe`, `kitchen`, `test`
//   Pipe was declared as a known for test instead of staying as a possible
// */
